...
describe("MyUsageHeader", () => {
  ...
  it("renders a visible usage documentation entry for readonly users", () => {
    ...
    const modelMarketLink = container.querySelector('a[href="/models"]');

    expect(docsLink).not.toBeNull();
    expect(docsLink?.textContent).toContain("Usage Docs");
    expect(modelMarketLink).not.toBeNull();
    expect(modelMarketLink?.textContent).toContain("Model Market");
